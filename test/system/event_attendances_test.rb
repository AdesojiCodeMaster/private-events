...
class EventAttendancesTest < ApplicationSystemTestCase
  ...
  test 'creating a Event attendance' do
    ...
    fill_in 'Attended event', with: @event_attendance.attended_event_id
    fill_in 'Attendee', with: @event_attendance.attendee_id
    fill_in 'Status', with: @event_attendance.status
