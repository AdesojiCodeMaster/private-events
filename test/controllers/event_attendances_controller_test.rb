...
class EventAttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create event_attendance' do
    assert_difference('EventAttendance.count') do
      post event_attendances_url, params:
      { event_attendance:
      { attended_event_id: @event_attendance.attended_event_id,
        attendee_id: @event_attendance.attendee_id, status: @event_attendance.status } }
    end
  ...
  test 'should update event_attendance' do
    patch event_attendance_url(@event_attendance), params:
    { event_attendance: { attended_event_id: @event_attendance.attended_event_id,
                          attendee_id: @event_attendance.attendee_id, status: @event_attendance.status } }
